"""
General-purpose AI Chat Agent for KrishiMitra
...
class ChatAgent(Agent):
    ...
    def __init__(self):
        ...
        # System prompts
        self.general_system_prompt = """You are KrishiMitra, an advanced AI assistant specialized in helping farmers across India.
...
"""
    ...
    def _init_ai_models(self):
        ...
        if settings.GEMINI_API_KEY_2 and settings.GEMINI_API_KEY_2 != "YOUR_GEMINI_API_KEY_NOT_SET":
            try:
                genai.configure(api_key=settings.GEMINI_API_KEY_2)
                # Using Gemini Flash Latest for capabilities and context window
    ...
    async def _chat_with_gemini(self, user_message: str, chat_history: List[Dict[str, Any]]) -> str:
        ...
        try:
            ...
            # Configure API key 2 for chat processing right before generation
            genai.configure(api_key=settings.GEMINI_API_KEY_2)
            # Generate response
