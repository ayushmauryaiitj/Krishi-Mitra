...
This is the frontend for **KrishiMitra: AI-powered Agriculture Assistant**.

## Overview
KrishiMitra empowers Indian farmers with actionable insights using AI. The frontend is built with React and Tailwind CSS, providing a modern, responsive, and mobile-friendly interface for yield prediction, disease detection, market prices, and AI chat.
