...
function ChatAssistant() {
  ...
  const [messages, setMessages] = useState([
    {
      role: "assistant",
      content: "Welcome to KrishiMitra AI! I'm here to assist with all your agricultural needs - from crop management and weather insights to market trends and farming advice. How can I help your farm thrive today?"
    }
  ]);
  ...
  const handleShare = () => {
    ...
    if (navigator.share) {
      navigator.share({ title: 'KrishiMitra Chat', text });
    } else {
