          ...
          <div className="hidden xl:flex items-center h-16">
            <div className="flex h-full">
              ...
              <NavLink
                to="/livestock"
                label="Livestock"
                icon={<FaWarehouse />} // We don't have a specific cow icon imported, using generic or maybe add one
                currentPath={location.pathname}
                previousPath={previousPath}
                isTransitioning={isTransitioning}
              />
...
const NavLink = ({
  ...
  return (
    <Link
      to={to}
      className="px-2 lg:px-3 mx-0.5 lg:mx-1 h-full flex items-center font-bold relative group whitespace-nowrap text-sm lg:text-base"
    >
